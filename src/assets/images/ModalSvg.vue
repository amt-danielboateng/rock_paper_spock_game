<template>
    <div v-if="props.isOpen" class="modal-content flex items-center justify-center inset-0 overflow-auto rounded-lg">
        <div class="absolute flex justify-between w-[100%] left-0 top-0 text-[#2C6EC3] pl-8 pt-3">
            <p class="text-lg cursor-pointer">RULES</p>
            <div class="text-[#808080] pr-8 cursor-pointer" @click="closeBtn">X</div>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" width="304" height="270">
            ...
            <g fill="none" fill-rule="evenodd">
                ...
                <text fill="#B1B4C5" font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="13"
